      ...
      <aside className="w-64 bg-white border-r border-slate-200 text-slate-800 flex flex-col justify-between shrink-0 select-none">
        <div>
          <div className="px-6 py-6 flex items-center space-x-3.5 border-b border-slate-100">
            ...
            <span className="text-xl font-extrabold text-slate-800 tracking-tight leading-none font-sans">RatingApp</span>
          ...
          <nav className="mt-6 px-4 space-y-7">
            <div className="space-y-1.5">
              ...
              <button
                ...
                className={`w-full flex items-center space-x-3.5 px-4 py-2.5 rounded-xl text-sm font-semibold transition-all hover:bg-slate-100 hover:text-slate-900 ${
                  activeTab === 'store-info' ? 'text-slate-900 bg-slate-100 shadow-sm' : 'text-slate-650'
                }`}
              >
                <svg className="h-5 w-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="flex items-center space-x-6 text-sm text-slate-700">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="font-bold text-black">
                  {currentUser ? currentUser.name : 'Store Owner'}
                </span>
              </div>

              
              <div className="relative p-2 hover:bg-slate-100 rounded-full cursor-pointer transition">
                <svg className="h-5 w-5 text-slate-505 hover:text-slate-750" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9" />
                </svg>
                <span className="absolute top-1 right-1 h-3.5 w-3.5 bg-black text-white rounded-full text-[8px] font-extrabold flex items-center justify-center">
                  1
                </span>
              </div>
              ...
              {activeTab === 'dashboard' && (
                <div className="space-y-6">
                  <div className="flex justify-between items-center flex-wrap gap-4 select-none">
                    <div>
                      <h1 className="text-lg font-bold text-black tracking-tight">{data.storeName}</h1>
                      <p className="text-xs text-slate-500 mt-0.5">Assigned outlet metrics and score statistics</p>
                    </div>

                    
                    <div className="bg-white border border-slate-200/50 rounded-xl p-3 flex items-center space-x-3 shadow-sm select-none">
                      ...
                      <div>
                        ...
                        <div className="text-sm font-bold text-black mt-0.5">
                          {data.averageRating.toFixed(1)} <span className="text-[10px] text-slate-500 font-medium">/ 5</span>
                        </div>
                        <div className="text-[9px] text-slate-500">Based on {data.ratings.length} reviews</div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="bg-white border border-slate-200/50 rounded-xl p-3.5 shadow-sm">
                      <div className="text-[9px] text-slate-400 uppercase font-bold tracking-wider mb-0.5">Total Feedbacks</div>
                      <div className="text-sm font-bold text-black">{data.ratings.length} reviews</div>
                    </div>

                    <div className="bg-white border border-slate-200/50 rounded-xl p-3.5 shadow-sm">
                      <div className="text-[9px] text-slate-400 uppercase font-bold tracking-wider mb-0.5">Active Status</div>
                      <div className="text-sm font-bold text-black">Online</div>
                    </div>
                  </div>
                  ...
                  <div className="bg-white border border-slate-200/50 rounded-xl p-5 shadow-sm">
                    <div className="flex justify-between items-center mb-3 pb-2 border-b border-slate-100">
                      <h3 className="text-xs font-bold text-black">Recent Customer Ratings</h3>
                      <button onClick={() => setActiveTab('ratings')} className="text-xs font-bold text-black hover:underline">View All</button>
                    </div>
                    {data.ratings.length === 0 ? (
                      <div className="text-center py-6 text-slate-400 font-medium text-xs">No ratings submitted for your store yet.</div>
                    ) : (
